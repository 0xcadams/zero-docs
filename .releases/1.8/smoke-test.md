...
| `zmail/main`            | Pass                                    | Pass, unchanged                                          | Targeted changed files pass; repository check is blocked by an unrelated existing file | Pass               | N/A                                                                           | Pass                             | Pending  | Retains zero-virtual 0.5.1 and its existing list implementation.                                                                   |
| `ztunes/main`           | Pass                                    | Pass, generated schema updated for `drizzle-zero@0.19.0` | Targeted changed files pass; repository check has existing warnings                    | Baseline-blocked   | N/A                                                                           | Pass                             | Pending  | Retains zero-virtual 0.4.2. Three TanStack/Vite errors reproduce unchanged on `origin/main`; the existing Vite warning remains.    |
...
2. Use arrow keys near loaded-page boundaries; selection should remain visible.
